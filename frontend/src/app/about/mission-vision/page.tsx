...
const MissionVisionPage = () => {
  ...
  useEffect(() => {
    if (data?.missionVision?.seo) {
      const seo = data.missionVision.seo;
  ...
  const renderMissionVision = () => (
    <section key="missionVision" className="py-24 px-4 bg-white relative">
  ...
  const renderCoreValues = () => (
    <section key="coreValues" className="relative py-24 px-4 bg-gradient-to-br from-white via-blue-50/20 to-white overflow-hidden">
      {/* Background Pattern */}
  ...
  const renderCommitment = () => (
    <section key="commitment" className="relative py-32 px-4 overflow-hidden">
      {/* Background Image */}
  ...
  const sectionConfig = missionVision.sections || {
    ...
    missionVision: { isVisible: true, order: 2 },
    coreValues: { isVisible: true, order: 3 },
    commitment: { isVisible: true, order: 4 },
    whyItMatters: { isVisible: true, order: 5 },
    cta: { isVisible: true, order: 6 }
  };
    ...
    <main className="bg-white overflow-hidden">
      {activeSections.map((sectionName) => {
        switch (sectionName) {
          ...
          case "coreValues":
            return renderCoreValues();
          case "commitment":
            return renderCommitment();
          case "whyItMatters":
            return renderWhyItMatters();
          case "cta":
            return renderCTA();
          default:
            return null;
